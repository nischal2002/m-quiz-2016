...
def classThreeQuiz(): # Class 3
    '''this will the Quiz for CLASS 3'''
    questionCount = 0
    correctAnswers = 0
    while(questionCount < QUESTION_COUNT):
        if (additionQuestionClassThree()) :
...
def additionQuestionClassThree(): #class 3
...
def additionQuestion(a,b): #class 3
    ''' This will ask a addition question and will wait for user 
        input and will validate and input. It will terurn boolean true or false
        based on if the user input is correct or wrong '''
...
def subtractionQuestion(a,b): #class 3
